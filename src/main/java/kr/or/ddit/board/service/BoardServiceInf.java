...
public interface BoardServiceInf {
	 ...
	 * @param brdVo
	 * @return
	 * Method 설명 : BrdVo 를 매개변수로 받아 해당 Vo를 Db에 추가하는 메서드 brd_pid 부분은 null 이다
	 */
	 ...
	 * 변경이력 :
	 * @return
	 * Method 설명 : 가장 숫자가 큰 id 를찾는다 (최근게시글)
	 */
	public int maxBoard();
	 ...
	 * @param brdtVo
	 * @return
	 * Method 설명 : 새로운 게시판의 종류를 생성하는 메서드
	 */
